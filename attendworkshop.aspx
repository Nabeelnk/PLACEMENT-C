<%@ Page Language="C#" AutoEventWireup="true" CodeFile="attendworkshop.aspx.cs" Inherits="attendworkshop" %>
    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="current"><a href="attendworkshop.aspx" class="m4">Workshop</a></li>
          <li><a href="attendseminar.aspx" class="m4">Seminar</a></li>
  ...
  <div class="container">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [wid], [Topic], [venue], [date], [time], [location], [resoperson] FROM [tbl_workshop]">
        </asp:SqlDataSource>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:BoundField DataField="wid" HeaderText="wid" InsertVisible="False" 
                ReadOnly="True" SortExpression="wid" Visible="False" />
