<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArrearWise.aspx.cs" Inherits="ArrearWise" %>
  ...
  <div class="container">
    ...
    <div>
        ...
        <table style="width:100%;">
            <tr>
                <td class="style1">
                    SELECT ARREAR WISE<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="image" HeaderText="image" SortExpression="image" />
                ...
                <td>
                <asp:DropDownList ID="sup" runat="server" AutoPostBack="True">
            ...
            <tr>
                ...
                <td>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM [StudentRegistration] WHERE ([supplimentory] = @supplimentory)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="sup" Name="supplimentory" 
