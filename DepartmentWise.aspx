<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentWise.aspx.cs" Inherits="DeptWise" %>
...
<div class="wrap">
  ...
  <div class="container">
    ...
    <section id="content"><form id="form1" runat="server" style="overflow: scroll">
    <div>
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td class="style3">
                <asp:DropDownList ID="dept" runat="server" AutoPostBack="True" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [StudentRegistration] WHERE ([Department] = @Department)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="dept" Name="Department" 
