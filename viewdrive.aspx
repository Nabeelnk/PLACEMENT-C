<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewdrive.aspx.cs" Inherits="view_drive" %>
    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="current"><a href="viewdrive.aspx" class="m2">View Drive</a></li>
            ...
            <tr>
                <td class="style2">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [Cid], [CompanyName], [Designation], [JobDescription], [contact] FROM [tbl_company]">
                    </asp:SqlDataSource>
