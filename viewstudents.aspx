...
<div class="wrap">
    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="last"><a href="staffprofile.aspx" class="m5">Profile</a></li>
        </ul>
      </nav>
  ...
  <div class="container">
    <aside>
      <h3>Categories</h3>
      <ul class="categories">
        <li><span><a href="ViewStudents.aspx">Student</a></span></li>
        <li class="last"><span><a href="StaffDetails1.aspx">Staff</a></span></li>
      </ul>
    </aside>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td class="style3">
                    <asp:HyperLink ID="HyperLink1" runat="server" 
                        NavigateUrl="~/DepartmentWise.aspx">CLICK HERE</asp:HyperLink>
                    <br />
                </td>
                <td class="style3">
                </td>
            ...
            <tr>
                <td class="style2">
                    SEM WISE</td>
                <td class="style3">
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/SemWise.aspx">CLICK HERE</asp:HyperLink>
                    <br />
                </td>
                <td class="style3">
                </td>
            ...
            <tr>
                <td class="style2">
                    ARREAR WISE</td>
                <td class="style3">
                    <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/ArrearWise.aspx">CLICK HERE</asp:HyperLink>
                    <br />
                </td>
                <td class="style3">
                </td>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:HyperLink ID="HyperLink4" runat="server" 
                        NavigateUrl="~/PercentageWise.aspx">CLICK HERE</asp:HyperLink>
                </td>
                <td class="style3">
                </td>
            </tr>
