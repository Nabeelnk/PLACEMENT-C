<%@ Page Language="C#" AutoEventWireup="true" CodeFile="attendtraining.aspx.cs" Inherits="attendtraining" %>
    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="current"><a href="attendtraining.aspx" class="m3">Training</a></li>
  ...
  <div class="container">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [trainID], [Venue], [Date], [Time], [Location], [ResoPerson] FROM [tbl_training]">
        </asp:SqlDataSource>
