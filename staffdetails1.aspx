<%@ Page Language="C#" AutoEventWireup="true" CodeFile="staffdetails1.aspx.cs" Inherits="staffdetails1" %>
...
<div class="wrap">
  ...
  <div class="container">
            ...
            <tr>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT STAFFid, Firstname, Lastname, Age, Department, Subject, Emailid, MobileNumber, image FROM tbl_staff">
                        <DeleteParameters>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="STAFFid" DataSourceID="SqlDataSource1" Height="423px" 
        Width="987px">
        <Columns>
